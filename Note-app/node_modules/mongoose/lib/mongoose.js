...
/**
 * Creates a Connection instance.schema, collection, options) {
  const _mongoose = this instanceof Mongoose ? this : mongoose;
...
/**
 * An array containing all [connections](conn
 *
...
Mongoose.prototype.model = function(name, ection.html) associated with this
